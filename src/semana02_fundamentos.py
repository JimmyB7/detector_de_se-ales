...
# 1. Simulación de características extraídas de la cámara (ej. forma, color predominante)
# Supongamos 3 clases de señales:
# Clase 0: PARE (Stop)
...
if __name__ == "__main__":
  ...
  print(f"Accuracy del modelo de clasificación: {
    accuracy_score(y_test, pred):.3f}\n")
